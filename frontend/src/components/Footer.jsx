...
export default function Footer() {
  return (
    <footer className="border-t border-white/10 bg-surface/50 py-12 px-6">
      <div className="container mx-auto max-w-6xl">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="flex items-baseline gap-1 text-2xl font-heading tracking-tight z-50 group">
          ...
          <div className="flex items-center gap-4">
            <a href="https://github.com/Yashwantsahu9907" target="_blank" rel="noopener noreferrer" className="p-2 text-gray-400 hover:text-white transition-colors">
            ...
            <a href="https://www.linkedin.com/in/yashwant-sahu-0b008b345/" target="_blank" rel="noopener noreferrer" className="p-2 text-gray-400 hover:text-white transition-colors">
            ...
            <a href="https://leetcode.com/u/yashwant789/" target="_blank" rel="noopener noreferrer" className="p-2 text-gray-400 hover:text-white transition-colors">
        ...
        <div className="mt-8 pt-8  border-t border-white/5 text-center text-gray-500 text-sm flex flex-col md:flex-row justify-between items-center justify-center gap-4">
          <p>&copy; {new Date().getFullYear()} Yashwant Sahu. All rights reserved.</p>
