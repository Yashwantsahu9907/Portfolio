...
const profileImg = 'https://avatars.githubusercontent.com/u/9907?v=4';
    ...
    const fetchResume = async () => {
      try {
        ...
        if (res.data && res.data.url) {
          setResumeUrl(`http://localhost:5000${res.data.url}`);
        } else {
          setResumeUrl('#');
        }
      } catch (error) {
        ...
        <div className="flex flex-col-reverse lg:flex-row items-center gap-16 lg:gap-8">
          ...
          >
            ...
            <motion.p variants={itemVariants} className="text-lg md:text-xl text-gray-400 max-w-2xl mb-10 leading-relaxed">
              I architect and build scalable, secure, and beautiful digital experiences. 
              Bridging the gap between cutting-edge engineering and premium user interfaces to create products that people love.
            </motion.p>
